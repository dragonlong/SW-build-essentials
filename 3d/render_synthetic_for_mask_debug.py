...
def render_data(path_urdf, ind_urdf, _WRITE_FLAG=True, _RENDER_FLAG=True, _CREATE_FOLDER=True, RENDER_NUM=100, ARTIC_CNT=20):
    ...
    tree_urdf = ET.parse("{}/{:04d}/urdf/syn.urdf".format(path_urdf, ind_urdf))
    ...
    for i in range(num_joints+1):
        obj_p = pybullet.loadURDF("{}/{:04d}/urdf/syn_p{}.urdf".format(path_urdf, ind_urdf, i))
...
if __name__ == "__main__":
    ...
    _RENDER  = True
    _CREATE  = False
    num_render= 5   # per articulation status
