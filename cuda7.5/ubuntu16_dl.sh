...
# Add cuda to path
echo -e "export PATH=/usr/local/cuda-7.5/bin\${PATH:+:\${PATH}}" >> ~/.bashrc
echo -e "export LD_LIBRARY_PATH=/usr/local/cuda-7.5/lib64\${LD_LIBRARY_PATH:+:\${LD_LIBRARY_PATH}}" >> ~/.bashrc
source ~/.bashrc
